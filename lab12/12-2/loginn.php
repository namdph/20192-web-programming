        ...
        <form method="POST" action="<?php echo $_SERVER['PHP_SELF'] ?>" name="frmLogin" onsubmit="return fCommit();"> 
            <table border="0" width="100%" height="100%" cellspacing="0" cellpadding="0">
                <tr valign="middle"><td align="center"> 
                        <table> 
                            <tr> 
                                <td><p class="reporttitie">LOGIN TO THE SYSTEM</p></td> 
                            </tr>
                        </table> 
                        <table class="forumline" width="280" border="0" cellspacing="1" cellpadding="2"> 
                            <tr class="formstyle"><td> 
                                    <table width="100%" border="0" cellpadding="2" cellspacing="0"> 
                                        ...
                                        <tr class="formstyle"> 
                                            <td class="th-caption" align="right" width="403"> Password:&nbsp;</td> 
                                            <td class="th-caption" width="603">&nbsp;
                                     ...
                                     <td colspan="2">
                                     <p class="error">Invalid name and/or password!</p>
                                     </td> 
                                     </tr>';
                                        }
